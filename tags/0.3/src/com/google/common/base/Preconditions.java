...
/*
 * Note: this Preconditions implementation is taken from Guava library
 * to decrease number of project dependencies.
 * 
 * There is similar implementation in com.google.inject.internal.Preconditions,
 * but it should not be used since it is internal to Google Guice. 
 * 
 * Guava library home: http://code.google.com/p/guava-libraries/
 */
