...
/**
 * IULoan implementation for engine
 * 
 * @author pupatenko
 * 
 * @see IULoan
 */
public class LoanEngine implements IULoan {
	...
	public LoanEngine(BankTransactionType type, long bankId, long clientId,
	...
	public LoanEngine(IULoan toCopy) {
		type = toCopy.getType();
