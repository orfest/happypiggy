...
public class PublishScreen extends GameTab implements Bindable, InjectionVisitable, ICompanyMessageListener, ITurnChangeListener {
	...
	@WTKX private ListView newsList;
	@WTKX private CardPane messageTypeCP;
	@WTKX private Label titleLabel;
	@WTKX private TextArea descriptionTA;
	@WTKX private Label effectLabel;
	@WTKX private ListView recipientCheckList;
	@WTKX private PushButton selectAllPB;
	@WTKX private PushButton selectNonePB;
	@WTKX private Label numRecipientsLabel;
	@WTKX private PushButton publishPB;
	/*
	 * Injectables.
	 */
