...
import ru.nsu.ccfit.pm.econ.view.server.PublishScreen;
...
public class ServerWindow extends Window implements Bindable, InjectionVisitable, IPlayerStatsUpdateListener {
	
	static final Logger logger = LoggerFactory.getLogger(ServerWindow.class);
	
	private static final String RES_TITLE = "s.windowTitle";
	...
	@WTKX private StartSheet startSheet;
	...
	@WTKX private PublishScreen publishScreen;
